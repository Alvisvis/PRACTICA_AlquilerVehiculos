...
//                                break;
    ...
    private static void menu() {
        ...
        ES.escribirLn("5. Listados");
        ES.escribirLn("------------------------------------------");

        ES.escribirLn("6. Eliminar");
        ES.escribirLn("------------------------------------------");

        ES.escribirLn("Alquilar");
        ES.escribirLn("7. Nuevo alquiler");
        ES.escribirLn("8. Cerrar un alquiler");
        ES.escribirLn("------------------------------------------");

        ES.escribirLn("Archivos");
        ES.escribirLn("9. Guardar datos");
        ES.escribirLn("10. Leer archivos guardados");
//        ES.escribirLn("11. Base de datos");
    ...
    public static void menuListado() {
        ...
        do {
            ES.escribirLn("""
                            Que listado quieres ver?
                      1- Clientes por nombre
                      2- Clientes por localidad
                      3- Vehiculos por marca
                      4- alquileres por fecha de inicio del mismo
                      5- alquileres por apellidos de cliente
                      0- Salir""");
            op = ES.leerEntero("");
            switch (op) {
                case 1:
                    ...
                    break;
                case 2:
                    clientes.sort((o1, o2) -> o1.getLocalidad().compareTo(o2.getLocalidad()));
                    ListarCliente();
                    break;
                case 3:
                    vehiculos.sort((o1, o2) -> o1.getMarca().compareTo(o2.getMarca()));
                    ListarVehiculo();
                    break;
                case 4:
                    alquileres.sort((o1, o2) -> {
                        return o1.getFecha().compareTo(o2.getFecha());
                    });
                    ListarAlquiler();
                    break;
                case 5:
                    alquileres.sort((o1, o2) -> o1.getCliente().getNombre().compareTo(o2.getCliente().getNombre()));
                    ListarAlquiler();
                    break;
            }
        } while (op != 0);
    ...
    public static void menuEliminacion() {
        ...
        do {
            ES.escribirLn("""
                      ...
                      1- Eliminar todos los vehiculo de una marca
                      2- Eliminar los alquileres que tengan una marca dada
                      3- Eliminar los alquileres que tengan una fecha menor que la indicada""");
            op = ES.leerEntero("");
            switch (op) {
                case 1:
...
//    }
    ...
    private static Cliente insertarCliente() {
        Cliente c;
        String dni = ES.leerCadena("Introduce el DNI o NIE del cliente: ");
        ...
        while (!Utilidades.comprobarCodigoPostal(codigoPostal)) {
            ES.escribirLn("Este codigo postal no es valido, vuelva a introducirlo");
    ...
    private static Vehiculo insertarVehiculo() {
        ...
        while (!Utilidades.comprobarMatricula(matricula)) {
            ...
            matricula = ES.leerCadena("Introduce el matricula del vehiculo: ");
        }
        ...
        if (tipo == 1) {
            ...
            int nPuertas = ES.leerEntero("Introduce el numero de puertas del vehiculo: ");
            if (nPuertas > 4 || nPuertas < 2) {
                while (nPuertas > 4 || nPuertas < 2) {
                    ...
                    nPuertas = ES.leerEntero("Introduce el numero de puertas del vehiculo: ");
                }
            }
            ...
            if (subTipo == 1) {
                ...
                int nPlazas = ES.leerEntero("Introduce el numero de plazas del vehiculo: ");
            ...
            int pma = ES.leerEntero("Introduce el peso del vehiculo: ");
            int volumen = ES.leerEntero("Introduce el volumen del vehiculo: ");
    ...
    private static void eliminarAlquiler() {
        ...
        String dni = ES.leerCadena("Cual es el dni del cliente? ");
